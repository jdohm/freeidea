/**
 * @fileOverview this file provides functions to create new ideas
 * @name SideIdea.js
 * @author Jannis Dohm
 * @license MIT
 */
...
/**
 * function to send data of new idea to the server
 * idea title, description, tags, skills and the information
 * if the user wants to publish the idea on mastodon
 * will be read from the form created by the show function
...
function save(lon, lat) {
    ...
    let ideaText = document.getElementById("ideaText").value;
    let _tags = tagsArray.toString();
    let _skills = skillsArray.toString();
